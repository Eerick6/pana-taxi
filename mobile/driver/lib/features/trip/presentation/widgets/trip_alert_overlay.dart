                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          const SizedBox(width: 3),
                                          Text(
                                            '${alert.clientTotalTrips ?? 0} viajes',
                                            style: AppTextStyles.caption
                                                .copyWith(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: alert.fareMode == 'meter'
                                          ...
                                          : Text(
                                              '\$${(_currentPrice ?? alert.displayFare).toStringAsFixed(2)}',
                                              style: AppTextStyles.labelLg
                                                  .copyWith(
                                                    fontWeight: FontWeight.w800,
                                                  ),
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    '${alert.distanceKm!.toStringAsFixed(1)} km de recorrido',
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  const SizedBox(width: 12),
                                  Text(
                                    'Oferta enviada. Esperando al cliente…',
...
class _CounterOfferSheetState extends State<_CounterOfferSheet>
  ...
  void initState() {
    super.initState();
    _ctrl = TextEditingController(text: widget.currentPrice.toStringAsFixed(2));
