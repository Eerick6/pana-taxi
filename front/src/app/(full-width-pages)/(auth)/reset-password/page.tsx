    ...
    return (
      <div className="flex flex-col flex-1 lg:w-1/2 w-full">
        <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto text-center space-y-4">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm">Enlace de recuperación inválido.</p>
          <Link href="/forgot-password" className="text-sm text-brand-500 hover:underline">Solicitar nuevo enlace</Link>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex flex-col flex-1 lg:w-1/2 w-full">
        <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto text-center space-y-4">
          ...
          <h2 className="text-xl font-semibold text-gray-800 dark:text-white">Contraseña actualizada</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400">Ya puedes iniciar sesión con tu nueva contraseña.</p>
