      ...
      <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Si no recibiste el correo para crear tu contraseña, ingresa tu correo y te enviaremos uno nuevo.
          </p>
        </div>
        ...
        {sent ? (
          <div className="rounded-xl bg-green-50 dark:bg-green-500/10 border border-green-200 dark:border-green-500/20 p-5 text-center space-y-2">
            ...
            <p className="font-semibold text-green-700 dark:text-green-400 text-sm">Correo enviado</p>
            <p className="text-sm text-green-600 dark:text-green-500">
              Si el correo <span className="font-semibold">{email}</span> tiene una cuenta pendiente de activación, recibirás el enlace en los próximos minutos.
            </p>
            <p className="text-xs text-gray-500 dark:text-gray-600 mt-2">Revisa también la carpeta de spam.</p>
