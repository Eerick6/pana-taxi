        ...
        <div className="relative w-full max-w-2xl bg-gray-900 border border-gray-700 rounded-3xl shadow-2xl">
          ...
          <div className="flex items-start justify-between p-6 pb-4 border-b border-gray-800">
            <div>
              ...
              <p className="text-xs text-gray-400 mt-0.5">Documentos de la cooperativa</p>
            </div>
          ...
          {/* Footer with stats + cooperative approval */}
            ...
            {isPending && (
              <div className="border-t border-gray-800 pt-4 space-y-3">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    onClick={approveCoop}
                    disabled={!requiredApproved || coopActionLoading}
