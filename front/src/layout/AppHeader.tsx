...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-99999 flex w-full items-center bg-white border-b border-gray-200 dark:border-gray-800 dark:bg-gray-900">
      <div className="flex w-full items-center justify-between px-3 py-3 lg:px-6 lg:py-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/" className="lg:hidden overflow-hidden rounded-lg">
            <Image
              width={160} height={40}
              src="/images/logo/banner1.jpg"
              alt="Pana Taxi"
        ...
        {/* Right: actions — siempre visibles, alineadas a la derecha */}
